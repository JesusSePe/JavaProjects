...
public class Portatil extends Dispositivo implements Recargable, Comparable<Dispositivo>{
    // Attributes
    private Bateria bateria;

    // Constructor
    public Portatil(CPU cpu, RAM ram, HDD disco, Bateria bateria, int precioBase) {
